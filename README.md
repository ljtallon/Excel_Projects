...
- **Techniques:** Data cleaning, pivot tables, interactive charts, slicers  
- **My Role:** Designed and built the dashboard from scratch and created meaningful KPIs and visuals for insights.  

## Key Contributions  
- Cleaned and structured raw sales data for accurate reporting.  
- Built pivot tables and pivot charts to summarize performance by average income and customer commute. 
- Designed an interactive dashboard with slicers for filtering by marital status, region, and education.  
- Enabled users to quickly identify trends and make data-driven decisions.  
